...
import { useRolesListController } from "./controller/useRolesListController";

export function RolesListV1() {
  ...
  return (
    <div className="space-y-6">
      <AuthCenterHeader
        actionHref={routes.roleCreate}
        actionLabel={t("authz.roles.create")}
                ...
                >
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center justify-end gap-3">
                      <a className="text-xs font-semibold text-[var(--dashboard-accent)] hover:underline" href={routes.roleEdit(String(role.id))}>
                        {t("authz.roles.edit")}
                      </a>
                      <button
