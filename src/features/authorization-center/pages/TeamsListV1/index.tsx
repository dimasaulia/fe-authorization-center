...
export function TeamsListV1() {
  ...
  return (
    <div className="space-y-6">
      ...
      <FilterBar
        searchPlaceholder={t("authz.filter.search.teams")}
        secondaryFilterLabel="Organization"
        secondaryFilterOptions={["Internal Organization"]}
      />
      <section className="overflow-hidden rounded-2xl border border-[var(--dashboard-border)] bg-[var(--dashboard-panel)]">
        <div className="min-w-[820px]">
          ...
          {teams.map((team) => (
            <div
              className="grid grid-cols-[1.2fr_1fr_1.2fr_110px_120px_130px_180px] items-center border-b border-[var(--dashboard-border-soft)] px-4 py-4 text-sm last:border-b-0"
              key={team.id}
            >
